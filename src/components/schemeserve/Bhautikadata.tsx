...
interface BhautikDataall {
    ...
    yojna_name: string;
    collectionofdata?: string; // Add this line for the new column
}
...
const Bhautikadata: React.FC<Props> = ({
    ...
    const transformFormData = (data: BhautikData) => {
        ...
        return {
            ...
            gp_id: data.gp_id,
            collectionofdata: JSON.stringify(data), // Add this line to store all data as JSON
        };
    };
    ...
    const columns: Column<BhautikDataall>[] = [
        ...
        },
        {
            key: 'scheme_name',
            label: 'योजनाचे नाव',
            render: (data) => <span>{data.yojna_name || "-"}</span>,
        },
        {
