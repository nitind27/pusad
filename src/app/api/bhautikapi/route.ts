...
LEFT JOIN schemes ON bhautikdb.scheme_name = schemes.scheme_id
  ...
  try {
    const [result] = await pool.query<ResultSetHeader>(
      `INSERT INTO bhautikdb (
        ...
        allroadvillages, village_distance, taluka_id, village_id, gp_id, alltribalegaav, collectionofdata
      ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
      [
